...
const EditRutine = () => {
    ...
    const setBtn = async () => {
        ...
        const { s1, m1, t1, w1, th1, f1, st1,
            s2, m2, t2, w2, th2, f2, st2,
            s3, m3, t3, w3, th3, f3, st3,
            s4, m4, t4, w4, th4, f4, st4, } = rutine
        try {

            const res = await fetch("http://localhost:5000/set_rutine", {
                method: "POST",
                headers: {
    ...
    return (
        <div class="container1">
            ...
            <div className="editTitle" style={{ backgroundColor: '', paddingLeft: "20px", position: 'fixed', top: "20px", display: 'flex', alignItems: 'center' }}>
                <h2 style={{ color: 'white', fontSize: "35px", }}>
                    <i className="fa fa-tasks"></i>
                    <span> Set Rutine</span> </h2>

                <div className="btnEdit" style={{ display: "flex", position: 'relative', left: "100%", }}>
                    <form  >
                        <button style={{ color: 'green', fontSize: "20px", margin: "10px", cursor: "pointer" }}
                    ...
                    <div >
                        <button style={{ color: 'red', fontSize: "20px", margin: "10px", cursor: "pointer" }}
                            disabled
                            onClick={() => setBtn()}
                        >
                            Set Rutine
                ...
                {
                    load ? <h2 style={{ color: 'white' }}>
                        please wait...
                    </h2> : ""
                }
            </div>
            <div classname="mainTable " style={{ transform: "translateY(21%)" }}>
                <table class="table table-striped table-hover" style={{ margin: "auto ", backgroundColor: "#2a2f4b", width: "96%", height: "80vh", overflowX: "scroll" }}>
                    <thead>
                        <tr>
