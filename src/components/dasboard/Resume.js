...
function Resume() {
    ...
    const uplaodResume = async (e) => {
        ...
        try {
            ...
            const res = await fetch("http://localhost:5000/resume_uplaod", {
                method: "POST",
                headers: {
        ...
        <div style={{ width: '90%', color: 'white', margin: '20px auto' }}>
            <div className="title">
                ...
                <div className="btnGroup">
                    ...
                    <a href="https://novoresume.com/editor" target="_blank">
                        <button className="btn btn-success mx-3 ">Edit Resume</button>
                    </a>
                    <form action="" style={{ display: 'inline-block' }} >
                        <input type="file" name="resume" style={{ border: '1px solid white' }} id="file" title="select resume" onChange={resumeSelect} accept="image/pdf" />
            ...
            <div className="resume " style={{ height: '100vh' }}>
                ...
                <embed src={resume} style={{ height: '100vh', width: '100%' }} type="application/pdf">
