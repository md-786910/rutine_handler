            ...
            <form method="post" className="form-control m-auto w-50 p-5">
                <div className="mb-1">
                    ...
                    <input type="text" className="form-control" name="name"
                        value={user.name} id="exampleFormControlInput1" placeholder="john man.." onChange={setUserDetail} required />
                </div>
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" name="password"
                        value={user.password}
                        id="exampleFormControlInput1" placeholder="123" maxlength="10" onChange={setUserDetail} required />

                </div>
                <button className="btn btn-primary fs-5" onClick={submitDetails}>Register
                    <span>
                ...
                <NavLink to="/user_login/login">
                    <button className="btn btn-outlined-light fs-5 mx-4">Login
                        <span>
                            <i className="fa fa-user"></i>
                        </span>
                    </button>
